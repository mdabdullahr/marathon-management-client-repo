...
const HomeMarathons = () => {
  ...
  key={marathon._id}
  data-aos="fade-up"
  className="bg-white dark:bg-gray-800 rounded-3xl shadow-lg hover:shadow-2xl transition-shadow duration-300 transform hover:-translate-y-2 flex flex-col h-full"
>
  {/* Image */}
  ...
  <div className="flex flex-col justify-between flex-1 p-6">
    <div className="space-y-4">
      ...
      <p className="text-gray-500 dark:text-gray-400">
        ...
        <span className="font-semibold text-gray-700 dark:text-gray-200">
          {new Date(marathon.startRegistrationDate).toLocaleDateString("en-GB", {
            day: "2-digit",
            month: "short",
            year: "numeric",
          })}{" "}
          –{" "}
          {new Date(marathon.endRegistrationDate).toLocaleDateString("en-GB", {
            day: "2-digit",
            month: "short",
            year: "numeric",
          })}
    ...
    <Link
      ...
      className="mt-6 block w-full text-center bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-semibold py-3 rounded-xl transition duration-300"
    >
      View Details
    </Link>
  </div>
